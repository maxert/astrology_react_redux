...
export const SEARCH_ADD_FAVORITE = "SEARCH_ADD_FAVORITE";
export const SEARCH_DELETE_FAVORITE = "SEARCH_DELETE_FAVORITE";
export const SEARCH_SORT = "SEARCH_SORT";
export const SEARCH_SORT_FAVORITE = "SEARCH_SORT_FAVORITE";
export const SHOW_NOTAL_CARD = "SHOW_NOTAL_CARD";
export const FETCH_FAVORITE_LIST = "FETCH_FAVORITE_LIST";
export const FETCH_FAVORITE_ORDER = "FETCH_FAVORITE_ORDER";
export const SORT_DATA_EVENTS = "SORT_DATA_EVENTS";
...
export const SORTED_SAVE_SEARCH = "SORTED_SAVE_SEARCH";
export const SORTED_SAVE = "SORTED_SAVE";
